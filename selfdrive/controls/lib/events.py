...
#  },
  ...
  EventName.noTarget: {
    ET.IMMEDIATE_DISABLE: Alert(
      ...
      "No close lead car",
      AlertStatus.normal, AlertSize.mid,
      Priority.HIGH, VisualAlert.none, AudibleAlert.chimeDisengage, 2.4, 2., 3.),
  ...
  EventName.autoHoldActivated: {
    ET.PERMANENT: Alert(
      ...
      AlertStatus.normal, AlertSize.mid,
      Priority.LOWER, VisualAlert.none, AudibleAlert.chimeAutoholdon, 2.1, 0.4, .3),
  },
